...
class LazyMessage final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR LazyMessage(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  LazyMessage* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
