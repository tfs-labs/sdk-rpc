...
enum Foo_NestedEnum : int {
  ...
  Foo_NestedEnum_Foo_NestedEnum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  Foo_NestedEnum_Foo_NestedEnum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum FooWithExtraFields_NestedEnum : int {
  ...
  FooWithExtraFields_NestedEnum_FooWithExtraFields_NestedEnum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  FooWithExtraFields_NestedEnum_FooWithExtraFields_NestedEnum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
constexpr FooWithExtraFields_NestedEnum FooWithExtraFields_NestedEnum_NestedEnum_MAX = FooWithExtraFields_NestedEnum_MOO;
...
class FooWithExtraFields final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR FooWithExtraFields(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  FooWithExtraFields* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  static constexpr NestedEnum MOO =
    FooWithExtraFields_NestedEnum_MOO;
  static inline bool NestedEnum_IsValid(int value) {
